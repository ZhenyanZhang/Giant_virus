...
2. To prevent multicollinearity in the machine-earning models, we evaluated Spearman’s rank correlation among all **environmental factors** using spearman_cor.R. For highly correlated factors (|Spearman’s _r_| > 0.6), we exclusively retained the most representative and biologically meaningful one.
